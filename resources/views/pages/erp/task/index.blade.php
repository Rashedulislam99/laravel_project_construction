            ...
            <tbody>
                @forelse ($tasks as $task)
                    <tr>
                        ...
                        <td>{{ $task->manpower ?? '-' }}</td>
                        <td>
                            <a href="{{ url("system/tasks/$task->id/edit") }}"class="btn btn-sm btn-warning me-1"><svg
                            ...
                            <a href="{{ url("system/tasks/$task->id") }}"class="btn btn-info"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <form action="{{ url('system/tasks', $task->id) }}" method="POST" class="d-inline">
                                ...
                                <button type="submit" class="btn btn-sm btn-danger"
                                    onclick="return confirm ('Are you want to delete this task?')"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
